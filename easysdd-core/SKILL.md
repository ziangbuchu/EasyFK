...
- `easysdd-core/reference/shared-conventions.md` — 目录结构、YAML frontmatter 口径、`checklist.yaml` 生命周期、收尾 commit 约定、归档类共享规则
- `easysdd-core/reference/tools.md` — `search-yaml.py` / `validate-yaml.py` 用法
- `easysdd-core/reference/maintainer-notes.md` — 断点恢复、新增子工作流的登记
